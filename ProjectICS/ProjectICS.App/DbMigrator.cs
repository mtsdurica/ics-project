...
public class SqliteDbMigrator : IDbMigrator 
{
    ...
    public SqliteDbMigrator(IDbContextFactory<ProjectICSDbContext> dbContextFactory, DALOptions dalOptions)
    {
    ...
    {
        await using ProjectICSDbContext dbContext = await _dbContextFactory.CreateDbContextAsync(cancellationToken);
